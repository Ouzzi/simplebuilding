...
public class ModBlocks {
    ...
    public static final Block NIHILITH_ORE = registerBlock("nihilith_ore", unused -> new Block(AbstractBlock.Settings.copy(Blocks.END_STONE).registryKey(keyOf("nihilith_ore")).strength(25.0f, 1200.0f).requiresTool()));

    public static final Block ASTRALIT_ORE = registerBlock("astralit_ore", unused -> new Block(AbstractBlock.Settings.copy(Blocks.END_STONE).registryKey(keyOf("astralit_ore")).strength(20.0f, 1200.0f).luminance(state -> 5).requiresTool()));
