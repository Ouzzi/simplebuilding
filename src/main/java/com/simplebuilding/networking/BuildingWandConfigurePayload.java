...
public record BuildingWandConfigurePayload(int selectedRadius, int axisMode) implements CustomPayload {
    public static final CustomPayload.Id<BuildingWandConfigurePayload> ID = new CustomPayload.Id<>(new Identifier(Simplebuilding.MOD_ID, "building_wand_configure"));
