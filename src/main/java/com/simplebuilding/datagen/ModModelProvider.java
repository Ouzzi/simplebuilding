...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerators itemModelGenerator) {
        ...
        ModelTemplates.FLAT_ITEM.create(
                ...
                TextureMapping.layer0(new Material(Identifier.fromNamespaceAndPath(Simplebuilding.MOD_ID, "item/netherite_apple"))),
                itemModelGenerator.modelOutput
        );
        ModelTemplates.FLAT_ITEM.create(
                ModelLocationUtils.getModelLocation(ModItems.ENCHANTED_ENDERITE_APPLE),
                TextureMapping.layer0(new Material(Identifier.fromNamespaceAndPath(Simplebuilding.MOD_ID, "item/enderite_apple"))),
                itemModelGenerator.modelOutput
        );
    }
