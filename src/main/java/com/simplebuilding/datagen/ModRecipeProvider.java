            ...
            public void generate() {
                /*
                    ...
                    createShapeless(RecipeCategory.MISC, ModItems.RAW_PINK_GARNET, 32)
                            ...
                            .offerTo(exporter, RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(Simplebuilding.MOD_ID, "raw_pink_garnet_from_magic_block")));

                    offerSmithingTrimRecipe(ModItems.KAUPEN_SMITHING_TEMPLATE, ModTrimPatterns.KAUPEN,
                            RegistryKey.of(RegistryKeys.RECIPE, Identifier.of(Simplebuilding.MOD_ID, "kaupen")));
                */
            }
        };
    }
