 ...
 * on the 1.21.11 line, where the submit nodes are collected from
 * {@code WorldRenderEvents.BEFORE_ENTITIES}.
 *
            ...
            try {
                ...
                RendererTestScene.awaitOnClient(context,
                        client -> client.player != null
                                && client.player.getOffhandItem().is(Items.STONE),
                        "the stone material arriving in the offhand");
                ...
                RendererTestScene.awaitOnClient(context,
                        client -> client.player != null
                                && client.player.getMainHandItem().getItem() instanceof BuildingWandItem,
                        "the building wand arriving in the main hand");
