...
/**
 * Fabric (MC 1.21.11): schickt ein Rucksack-Menue ab. Was geoeffnet wird, entscheidet
 * {@link BackpackMenuProviders}; hier kommt nur der Fabric-Weg fuer die Oeffnungsdaten dazu
 * ({@code ExtendedScreenHandlerFactory}, auf 26.2 {@code ExtendedMenuProvider}).
 */
public final class BackpackMenus {
    ...
    private static void open(ServerPlayer player, BackpackMenuProviders.Opening opening) {
        player.openMenu(new ExtendedScreenHandlerFactory<BackpackOpenData>() {
            @Override
