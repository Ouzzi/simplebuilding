...
public final class BlueprintCodeArea extends AbstractWidget {
        ...
        for (int[] line : lines()) {
            ...
            if (lineIndex >= first && (lineIndex * lh - scroll) < viewHeight() + lh) {
                ...
                if (startsLogical) {
                    ...
                    g.drawString(font, number, nx, 0, GUTTER_TEXT, false);
                }
    ...
    private void drawLine(GuiGraphics g, String value, int begin, int end,
        ...
        while (run < end) {
            ...
            g.drawString(font, text, xPos, 0, STYLE_COLORS[style], false);
