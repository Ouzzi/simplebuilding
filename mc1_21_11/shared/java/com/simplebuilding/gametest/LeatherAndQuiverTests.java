...
public final class LeatherAndQuiverTests {
    ...
    public static void leatherSheetTakesExactlyNineLeather(GameTestHelper helper) {
        ...
        Assertions.valueEqual(helper, sheet.getCount(), 1, "leather sheets per nine leather");
        Assertions.valueEqual(helper, sheet.getMaxStackSize(), 64, "stack size of the leather sheet");
    ...
    public static void upgradesKeepContentsEnchantmentsAndName(GameTestHelper helper) {
        ...
        Assertions.valueEqual(helper, countIn(reinforcedBundle, Items.STONE), 5,
        ...
        Assertions.valueEqual(helper, countIn(reinforcedQuiver, Items.ARROW), REINFORCED_QUIVER_ARROWS,
        ...
        Assertions.valueEqual(helper, countIn(netheriteQuiver, Items.ARROW), REINFORCED_QUIVER_ARROWS,
    ...
    private static void assertKeptNameAndFunnel(GameTestHelper helper, ItemStack upgraded, String name, String what) {
        ...
        Assertions.valueEqual(helper, upgraded.getEnchantments().getLevel(enchantment(helper, ModEnchantments.FUNNEL)), 1,
