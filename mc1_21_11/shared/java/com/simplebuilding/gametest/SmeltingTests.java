...
public final class SmeltingTests {
    ...
    public static void longCookTimersSurviveTheSaveAndLoadAsInts(GameTestHelper helper) {
        ...
        helper.startSequence()
                .thenExecuteAfter(5, () -> {
                    Assertions.valueEqual(helper, timers(helper, furnace(helper, vanilla)),
                    ...
                    Assertions.valueEqual(helper, timers(helper, furnace(helper, netherite)),
    ...
    public static void furnaceMenuScalesLongCooksIntoTheShortRange(GameTestHelper helper) {
        ...
        Assertions.valueEqual(helper, control[0] + " / " + control[1] + " / " + control[2] + " / " + control[3],
