...
public final class TrimBonusTests {
    ...
    public static void tagKeyedPatternsCoverTheWholeDamageFamily(GameTestHelper helper) {
        ...
        try {
            ...
            Arrow arrow = detached(helper, EntityType.ARROW, "arrow");
    ...
    public static void magicIsSoftenedByTheVexPatternAndTheGoldAndLapisMaterials(GameTestHelper helper) {
        ...
        try {
            ...
            LivingEntity vex = detached(helper, EntityType.VEX, "vex");
            LivingEntity zombie = detached(helper, EntityType.ZOMBIE, "zombie");
            DamageSource magic = sources.magic();
    ...
    public static void flowReadsTheTypeNameOfTheProjectileThatLanded(GameTestHelper helper) {
        ...
        try {
            ...
            Entity playerCharge = detached(helper, EntityType.WIND_CHARGE, "wind charge");
            Entity breezeCharge =
                    detached(helper, EntityType.BREEZE_WIND_CHARGE, "breeze wind charge");
            Arrow arrow = detached(helper, EntityType.ARROW, "arrow");
    ...
    public static void attackerKeyedMaterialsReadTheEntityBehindTheHit(GameTestHelper helper) {
        ...
        try {
            ...
            LivingEntity pillager = detached(helper, EntityType.PILLAGER, "pillager");
            LivingEntity vindicator = detached(helper, EntityType.VINDICATOR, "vindicator");
            LivingEntity witch = detached(helper, EntityType.WITCH, "witch");
            LivingEntity zombie = detached(helper, EntityType.ZOMBIE, "zombie");
            LivingEntity wither = detached(helper, EntityType.WITHER, "wither");
            Arrow arrow = detached(helper, EntityType.ARROW, "arrow");
            WitherSkull skull = detached(helper, EntityType.WITHER_SKULL, "wither skull");
