...
public final class NetworkHandlerTests {
    ...
    public static void octantScrollCyclesShapesAndNudgesCornersByFacing(GameTestHelper helper) {
        ...
        Assertions.valueEqual(helper, OctantItem.SelectionShape.values().length, shapeCount,
    ...
    public static void masterBuilderPickTakesBlocksOutOfTheEnchantedBundle(GameTestHelper helper) {
        ...
        Assertions.valueEqual(helper, player.getMainHandItem().getCount(), BUNDLE_STONE,
        ...
        Assertions.valueEqual(helper, countLoose(player, Items.TORCH), 5,
        ...
        Assertions.valueEqual(helper, countInBundle(bundle, Items.STONE), stoneBefore,
                "stone in the bundle after a pick for an item it does not hold");
        Assertions.valueEqual(helper, countLoose(player, Items.TORCH), torchesBefore,
        ...
        helper.assertTrue(player.getMainHandItem().is(Items.TORCH)
                ...
                "a pick into a full inventory overwrote the stack in the hand, which now holds "
                        ...
                        + "refused instead");
        Assertions.valueEqual(helper, countInBundle(fullBundle, Items.STONE), BUNDLE_STONE,
    ...
    private static void fill(GameTestHelper helper, ItemStack bundle, ServerPlayer player, Item item) {
        ...
        Assertions.valueEqual(helper, countInBundle(bundle, item), BUNDLE_STONE,
