...
public class OreDetectorItem extends Item {
     ...
     * Methode, es gibt also keinen zweiten Suchpfad. Siehe {@code OreDetectorTests} auf der
     * 26.2-Linie; hier steht sie, damit beide Linien dieselbe Form haben.
     */
    @Nullable
    ...
    public InteractionResult useOn(UseOnContext context) {
        if (context.getPlayer() != null && context.getPlayer().isShiftKeyDown()) {
            ...
            if (!world.isClientSide()) {
                ...
                context.getPlayer().displayClientMessage(Component.literal("Calibrated to: ").withStyle(ChatFormatting.GREEN)
