 ...
 *
 * <p>Down-port of the 26.2 version. Two differences, both verified against the 1.21.11 bytecode:
 * the render states live in {@code net.minecraft.client.renderer.state} (not
 * {@code ...renderer.state.level}), and the position is the public field
 * {@code MovingBlockRenderState.blockPos}, not the accessor {@code blockPos()} of 26.2. Vanilla may
 * hand out a mutable position there, so every entry is snapshotted with {@code immutable()}.
 *
