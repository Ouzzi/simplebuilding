...
RULES: list[tuple[str, str, str]] = [
    ...
    (r"gameRenderer\.mainCamera\(\)", "gameRenderer.getMainCamera()",
     "GameRenderer nennt den Kamera-Getter auf 1.21.11 noch getMainCamera"),
    (r"public void item\(ItemStack stack, int x, int y\)", "public void renderItem(ItemStack stack, int x, int y)",
     "GuiGraphics zeichnet Items auf 1.21.11 mit renderItem, die Ueberschreibung im Rekorder"),
    (r"super\.item\(stack, x, y\)", "super.renderItem(stack, x, y)",
     "dito, der Aufruf der Elternmethode"),
    (r"so a plain extractRenderState\n(\s*)// would not see them\.", r"so a plain render would not\n\1// see them.",
     "Kommentar: auf 1.21.11 heisst der Durchgang render"),
