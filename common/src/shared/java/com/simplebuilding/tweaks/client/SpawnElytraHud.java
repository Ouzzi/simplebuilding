...
public final class SpawnElytraHud {
    ...
    public static boolean render(GuiGraphicsExtractor graphics) {
        ...
        int textY = y - 6;
        graphics.text(client.font, text, textX + 1, textY, 0xFF000000, false);
        graphics.text(client.font, text, textX - 1, textY, 0xFF000000, false);
        graphics.text(client.font, text, textX, textY + 1, 0xFF000000, false);
        graphics.text(client.font, text, textX, textY - 1, 0xFF000000, false);
        graphics.text(client.font, text, textX, textY, color, false);
        return true;
    }
}
